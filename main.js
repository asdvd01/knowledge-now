...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.search = function (searchText) {
        var requestBody = {
            query: {
                freetext: searchText
            },
...
var MaterialModule = /** @class */ (function () {
    ...
    MaterialModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_material__WEBPACK_IMPORTED_MODULE_0__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_3__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_0__["MatInputModule"]],
            exports: [_angular_material__WEBPACK_IMPORTED_MODULE_0__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_2__["MatIconModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_3__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_0__["MatInputModule"]],
        })
    ], MaterialModule);
...
module.exports = "\n<mat-form-field >\n    <button mat-button matPrefix mat-icon-button aria-label=\"Search\" (click)=\"updateList()\" >\n        <mat-icon>search</mat-icon>\n    </button>\n    <input matInput type=\"text\" placeholder=\"Search Articles\"   [(ngModel)]=\"searchText\" (keyup)=\"updateList()\" />\n    <button mat-button *ngIf=\"searchText\" matSuffix mat-icon-button aria-label=\"Clear\" (click)=\"searchText=''\">\n      <mat-icon>close</mat-icon>\n    </button>\n    \n  </mat-form-field>\n\n<ul>\n    <li *ngFor=\"let post of posts$ \">\n      <h1><a href=\"https://ashutoshdwivedi.service-now.com/{{ post.link }}\">{{ post.meta.number }}</a> : {{ post.title }}</h1>\n      <p  [innerHTML]=\"post.snippet\"></p>\n      </li>\n</ul>\n"
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.updateList = function () {
        var _this = this;
        this.data.search(this.searchText).subscribe(function (data) { return _this.posts$ = data["result"]["results"]; });
    };
    ...
    ], PostsComponent.prototype, "searchText", void 0);
...
module.exports = "nav {\n  background: #2D2E2E;\n  height: 100%; }\n  nav ul {\n    list-style-type: none;\n    padding: 0;\n    margin: 0; }\n  nav ul li a {\n      color: #fff;\n      padding: 20px;\n      display: block; }\n  nav ul li .activated {\n      background-color: #00a8ff; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = __webpack_require__(/*! /Users/ashutosh.dwivedi/office/ng6/src/main.ts */"./src/main.ts");
